...
export default function FloatingCTA() {
  ...
  return (
    <div
      className={`fixed bottom-6 right-4 sm:right-6 z-50 flex flex-col gap-3 transition-all duration-300 ${
    ...
    >
      ...
      <a
        ...
        className="w-12 h-12 text-white rounded-full flex items-center justify-center transition-all duration-200 hover:scale-110"
