...
const testimonials = [
  ...
  },
  {
    ...
    rating: 5,
    text: "My son needed urgent help for his board exams. TutorFind matched us with an excellent Chemistry tutor within hours. The free demo was a great way to assess before committing.",
    subject: "Chemistry",
  ...
  },
  {
    ...
    rating: 5,
    text: "The tutor I found through TutorFind has completely transformed my preparation. He has been teaching IIT-JEE for 10 years and really knows what the examiners want.",
    subject: "Physics",
