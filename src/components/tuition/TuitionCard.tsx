  ...
  return (
    <div className="bg-white rounded-xl shadow-md border border-slate-100 p-4 sm:p-5 hover:shadow-lg transition-shadow duration-200">
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="mt-2 text-[11px] text-slate-400 italic">
            Contact details available after applying
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3 mt-4 pt-4 border-t border-slate-100">
        ...
        <button
          className="flex-1 py-2.5 rounded-xl text-sm font-bold text-white transition-all hover:scale-[1.02] hover:shadow-lg"
          style={{ background: gradients.primary, boxShadow: shadows.primaryButton }}
        >
          Apply / Unlock Contact
        </button>
      </div>
    </div>
  );
